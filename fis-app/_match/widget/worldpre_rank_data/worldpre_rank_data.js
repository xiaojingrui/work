...
var worldpre_rank_data = {
    ...
    render: function() {
        ...
        this.tabArray = ["asia", "europe", "s-america", "nc-america", "africa", "oceanica"];
    ...
    bind: function() {
		...
		function tabClick(selector, index) {
			self.tabContainer.find(".tab-" + selector).on("click", function() {
                ...
                self.mainScroll(self.modRankContainer.find("#J-"+selector));
			});
		}

        self.mainScroll(self.modRankContainer.find("#J-asia"));
    },
...
module.exports = worldpre_rank_data;
